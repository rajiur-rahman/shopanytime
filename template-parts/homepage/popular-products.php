    ...
    <?php if ( true == get_theme_mod( 'shopanytime_homepage_popular_product_section', true ) ): ?>
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-8">
                    <div class="section-title text-center">
                        <h2 class="title ">
                        <?php echo get_theme_mod( 'shopanytime_homepage_propular_product_title', 'Popular Products' ) ?>
                        </h2>
                        <div class="sub-title">
                        <?php echo get_theme_mod( 'shopanytime_homepage_propular_product_sub_title', '' ) ?>
